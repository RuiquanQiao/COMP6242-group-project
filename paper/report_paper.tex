...
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/eurosat_ablation/test_top1_acc.png}
\end{minipage}\hfill
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/eurosat_ablation/val_top1_acc_curve.png}
\end{minipage}
\caption{Summary of Experiment 4.1. Left: final EuroSAT test top-1 accuracy by strategy. Right: validation top-1 trajectories across training epochs.}
\label{fig:main}
\end{figure*}
...
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/domain_gap/test_top1_acc.png}
\end{minipage}\hfill
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/domain_gap/transfer_gain_top1.png}
\end{minipage}
\caption{Cross-domain comparison. Left: downstream test top-1 accuracy. Right: top-1 transfer gain over training from scratch.}
\label{fig:domain}
\end{figure*}
...
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/data_fraction/test_top1_acc.png}
\end{minipage}\hfill
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/data_fraction/transfer_gain_top1.png}
\end{minipage}
...
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/forgetting_main/forgetting_top1.png}
\end{minipage}\hfill
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/forgetting_main/transfer_forgetting_tradeoff.png}
\end{minipage}
...
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/forgetting_domain_gap/forgetting_top1.png}
\end{minipage}\hfill
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/forgetting_domain_gap/transfer_forgetting_tradeoff.png}
\end{minipage}
...
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/forgetting_data_fraction/forgetting_top1_transfer_methods.png}
\end{minipage}\hfill
\begin{minipage}{0.455\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../outputs/new_style_picture/forgetting_data_fraction/transfer_forgetting_tradeoff.png}
\end{minipage}
