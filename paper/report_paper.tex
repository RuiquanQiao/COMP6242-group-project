...
\node[box={violet}{2.0cm}, minimum height=1.0cm] (scratch) at (-4.8,-5.6) {\texttt{scratch}};
\node[box={violet}{2.4cm}, minimum height=1.0cm] (linearprobe) at (-1.6,-5.6) {\texttt{linear\_probe}};
\node[box={violet}{2.2cm}, minimum height=1.0cm] (partialft) at (1.8,-5.6) {\texttt{partial\_ft}};
\node[box={violet}{2.0cm}, minimum height=1.0cm] (fullft) at (4.8,-5.6) {\texttt{full\_ft}};
...
\draw[arr] (transfer.south) -- (strategygroup.north);
\draw[arr] (strategygroup.south) -- (studygroup.north);
\draw[dashedarr] (studygroup.south) -- (forgetgroup.north);
\end{tikzpicture}%
}
