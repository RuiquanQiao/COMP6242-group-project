...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.86\columnwidth]{../outputs/new_style_picture/eurosat_ablation/test_top1_acc.png}
\vspace{0.35em}
\includegraphics[width=0.86\columnwidth]{../outputs/new_style_picture/eurosat_ablation/val_top1_acc_curve.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\columnwidth]{../outputs/new_style_picture/forgetting_main/forgetting_top1.png}
\vspace{0.35em}
\includegraphics[width=0.90\columnwidth]{../outputs/new_style_picture/forgetting_main/transfer_forgetting_tradeoff.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\columnwidth]{../outputs/new_style_picture/forgetting_domain_gap/forgetting_top1.png}
\vspace{0.35em}
\includegraphics[width=0.90\columnwidth]{../outputs/new_style_picture/forgetting_domain_gap/transfer_forgetting_tradeoff.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.90\columnwidth]{../outputs/new_style_picture/forgetting_data_fraction/forgetting_top1_transfer_methods.png}
\vspace{0.35em}
\includegraphics[width=0.90\columnwidth]{../outputs/new_style_picture/forgetting_data_fraction/transfer_forgetting_tradeoff.png}
